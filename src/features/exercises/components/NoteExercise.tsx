 ...
 *
 * Las opciones NO muestran su nota: son sonido. Pulsar una la hace sonar y la
 * selecciona a la vez —y volver a pulsar la ya elegida vuelve a sonar, tantas
 * veces como haga falta—, porque comparar de oído es justamente el ejercicio.
 * Solo al corregir se revela qué nota era cada una.
 */
    ...
    <View style={styles.container}>
      ...
      <View style={styles.options}>
        {exercise.options.map((option, index) => {
          ...
          const revealedLabel = note === null ? letter : format(note);
          ...
          return (
            <AnswerOption
              ...
              index={index}
              icon="volume-high"
              label={revealed ? revealedLabel : letter}
              sublabel={revealed ? letter : undefined}
